...
export const doBillStart = (restaurant_id, bill_id) => {
    return async function (dispatch, getState) {
        dispatch(doBillTypeSet('bill'))
...
export const doBillTypeSet = (billType) => {
    return { type: 'bill/SET_BILL_TYPE', billType }
}