...
export default function BillItem({ bill_item_id, clear, }) {
  const dispatch = useDispatch()

  const [name, caption, subtotal, currentDenom, availableLength, myClaimedLength,] = useBillItemSplitDetails(bill_item_id)
